...
//        Person marioRossi = new Person("Mario", "Rossi", "mario@gmail.com", marioDate, Gender.M);
//        personDAO.save(marioRossi);
//        Partecipation mario = new Partecipation(marioRossi, krap, ParticipationStatus.CONFIRMED);


//        marioRossi.setPartecipationList(new ArrayList<>(Arrays.asList(mario)));
        // SAVE
